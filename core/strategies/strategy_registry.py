...
TREND_MODEL = ModelDef(
    ...
    params=[
        ...
        _p("models.trend.ema20_bonus", "EMA20 Bonus", "float", 0.25,
        ...
        _p("models.trend.macd_bonus", "MACD Bonus", "float", 0.20,
           ...
           section="Signal Strength"),
        _p("models.trend.adx_bonus_max", "ADX Bonus Max", "float", 0.40,
...
SENTIMENT_MODEL = ModelDef(
    ...
    params=[
        ...
        _p("models.sentiment.min_headlines", "Min Headlines", "int", 3,
           ...
           section="Entry"),
        _p("models.sentiment.max_age_minutes", "Max Headline Age", "int", 480,
           min_val=60, max_val=1440, step=60,
           desc="Maximum headline age in minutes (8h default).",
           section="Entry"),
